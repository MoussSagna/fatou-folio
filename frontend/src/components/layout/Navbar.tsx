      ...
      <header className="fixed left-0 right-0 top-0 z-50 px-6 py-6 md:px-12">
        <nav className="mx-auto flex w-full max-w-7xl flex-row items-center justify-between">
          ...
          >
            <Link
                to="/#contact"
                className="flex items-center gap-2 rounded-full border border-white/20 px-5 py-2.5 text-sm transition-all duration-300 hover:border-white/50 hover:bg-white hover:text-black"
            >
                        <span>
                            {profile?.heroCtaText ||
                                "Parlons-en"}
